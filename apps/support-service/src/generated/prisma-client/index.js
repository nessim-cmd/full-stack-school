...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/support-service/src/generated/prisma-client",
    "support-service/src/generated/prisma-client",
  ]
...
path.join(process.cwd(), "apps/support-service/src/generated/prisma-client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/support-service/src/generated/prisma-client/schema.prisma")
